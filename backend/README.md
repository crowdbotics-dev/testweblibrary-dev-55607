...
## Project Structure
    ...
    ├── testweblibrary_dev_55607  # Django project configurations
...
1. Clone this repo and `cd testweblibrary_dev_55607`
...
2. Clone this repo and `cd testweblibrary_dev_55607`
